...
window.RWALegacyCanonical={version:'7.4.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'156'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="156"]')||document.documentElement.dataset.renkoMethodBootstrap==='156')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=156';s.async=false;s.dataset.renkoBootstrap='156';document.body.appendChild(s);
    };
