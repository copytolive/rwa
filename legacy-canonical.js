...
window.RWALegacyCanonical={version:'7.3.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'155'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="155"]')||document.documentElement.dataset.renkoMethodBootstrap==='155')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=155';s.async=false;s.dataset.renkoBootstrap='155';document.body.appendChild(s);
    };
