...
window.RWALegacyCanonical={version:'8.0.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'184'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="184"]')||document.documentElement.dataset.renkoMethodBootstrap==='184')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=184';s.async=false;s.dataset.renkoBootstrap='184';document.body.appendChild(s);
    };
