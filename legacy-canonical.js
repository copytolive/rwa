...
window.RWALegacyCanonical={version:'7.9.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'181'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="181"]')||document.documentElement.dataset.renkoMethodBootstrap==='181')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=181';s.async=false;s.dataset.renkoBootstrap='181';document.body.appendChild(s);
    };
