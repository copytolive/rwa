...
window.RWALegacyCanonical={version:'7.6.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'158'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="158"]')||document.documentElement.dataset.renkoMethodBootstrap==='158')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=158';s.async=false;s.dataset.renkoBootstrap='158';document.body.appendChild(s);
    };
