...
window.RWALegacyCanonical={version:'7.8.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'180'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="180"]')||document.documentElement.dataset.renkoMethodBootstrap==='180')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=180';s.async=false;s.dataset.renkoBootstrap='180';document.body.appendChild(s);
    };
