...
window.RWALegacyCanonical={version:'7.7.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'171'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="171"]')||document.documentElement.dataset.renkoMethodBootstrap==='171')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=171';s.async=false;s.dataset.renkoBootstrap='171';document.body.appendChild(s);
    };
