...
window.RWALegacyCanonical={version:'7.2.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'154'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="154"]')||document.documentElement.dataset.renkoMethodBootstrap==='154')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=154';s.async=false;s.dataset.renkoBootstrap='154';document.body.appendChild(s);
    };
