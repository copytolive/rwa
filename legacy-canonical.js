...
window.RWALegacyCanonical={version:'7.5.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'157'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="157"]')||document.documentElement.dataset.renkoMethodBootstrap==='157')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=157';s.async=false;s.dataset.renkoBootstrap='157';document.body.appendChild(s);
    };
