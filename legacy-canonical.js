...
window.RWALegacyCanonical={version:'8.0.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'182'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="182"]')||document.documentElement.dataset.renkoMethodBootstrap==='182')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=182';s.async=false;s.dataset.renkoBootstrap='182';document.body.appendChild(s);
    };
