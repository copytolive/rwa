...
window.RWALegacyCanonical={version:'8.0.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'183'};
try{
  ...
  if(renkoPath){
    ...
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="183"]')||document.documentElement.dataset.renkoMethodBootstrap==='183')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=183';s.async=false;s.dataset.renkoBootstrap='183';document.body.appendChild(s);
    };
