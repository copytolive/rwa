...
window.RWALegacyCanonical={version:'8.0.0',canonical:'https://copytolive.github.io/rwa/',renkoStandalone:true,renkoController:'186'};
try{
  ...
  if(renkoPath){
    ...
    if(!document.querySelector('link[data-renko-mobile-first-frame="186"]')){
      const css=document.createElement('link');css.rel='stylesheet';css.href='renko-v15-mobile-first-frame.css?v=186';css.dataset.renkoMobileFirstFrame='186';document.head.appendChild(css);
    }
    const boot=()=>{
      if(document.querySelector('script[data-renko-bootstrap="186"]')||document.documentElement.dataset.renkoMethodBootstrap==='186')return;
      const s=document.createElement('script');s.src='renko-v15-controller-bootstrap.js?v=186';s.async=false;s.dataset.renkoBootstrap='186';document.body.appendChild(s);
    };
