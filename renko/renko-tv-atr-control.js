...
function clearStable(reason='clear'){
  ...
  delete T.state.atrBoxFrozen;delete T.state.atrBoxFrozenAt;
  Object.assign(document.documentElement.dataset,{renkoAtrStableBox:'false',renkoAtrStableBoxValue:'',renkoAtrStableReason:String(reason)});
...
window.RWARenkoATRControl={version:'1.3.1',rule:'xaut-deep-matrix-other-pairs-local-fixed1s-atr-snapshot-box-stable-between-closes-runtime-only-visible-ui-stable',applyLocal,ensureHistory,isLocal,autoLock,markStable,clearStable,stats};
})();
