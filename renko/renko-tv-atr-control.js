...
window.RWARenkoATRControl={version:'1.3.0',rule:'xaut-deep-matrix-other-pairs-local-fixed1s-atr-snapshot-box-stable-between-closes-runtime-only',applyLocal,ensureHistory,isLocal,autoLock,markStable,clearStable,stats};
})();
