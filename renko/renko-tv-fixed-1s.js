 ...
 * The mathematical box size and final Renko state stay unchanged. Only the
 * newest bounded geometry tail is materialized for Lightweight Charts. This is
 * equivalent to viewport/history virtualization: total confirmed count is kept
 * separately while millions of off-screen synthetic bricks are not retained in
 * Chromium memory during pair switching.
 */
(()=>{
'use strict';
