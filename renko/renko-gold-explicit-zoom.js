...
publish();
window.RWARenkoGoldExplicitZoom={version:'1.0.0-explicit-zoom',implementation:'1.2.1-deficit-history-demand',rule:'Zoom is the sole logical-width owner. Intentional +, -, vertical-wheel, and Ctrl/Meta pinch can zoom from 12 to 2500 logical bricks. Zoom-out relaxes the minimum spacing constraint and demand-loads older canonical history only when the requested viewport has a real brick coverage deficit or enters meaningful blank-left space. Horizontal or mixed wheel remains pan-only in the downstream fixed-width controller.',stats,zoomBy,isZoomWheel,releaseViewport,requestOlderHistory,historyNeeded,get maxWidth(){return MAX_WIDTH},get historyPumpActive(){return historyPump}};
})();