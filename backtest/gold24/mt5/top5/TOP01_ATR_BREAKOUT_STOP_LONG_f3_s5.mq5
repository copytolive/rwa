...
const int FAST=3;
const int SLOW=5;
const double ATR_MULT=2.2;
const double SL_USD=11.0;
const double TP_USD=15.5;
const double OFFSET_USD=3.25;
const int EXPIRY_BARS=7;
const bool LONG_ONLY=true;
const bool SHORT_ONLY=false;
