...
def main() -> int:
    ...
    payload = {
        ...
        "registered_target_engine_family_count": int(master_universe.get("registered_target_engine_family_count", len(IMPLEMENTED_FAMILIES))),
        "data_blocked_engine_family_count": int(master_universe.get("data_blocked_engine_family_count", 0)),
        "data_blocked_engine_families": master_universe.get("data_blocked_engine_families", []),
    ...
    atomic_json(out / "latest_multimethod_v1_discovery_summary.json", {
        k: payload[k] for k in [
            ...
            "implemented_category_count", "generated_family_counts_this_run", "generated_category_counts_this_run",
