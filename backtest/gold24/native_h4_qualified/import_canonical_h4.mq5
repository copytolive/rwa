// GOLD24 native H4 canonical custom-symbol importer for native MT5 certification.
#property strict
#property script_show_inputs
input string InpOriginSymbol = "XAUUSD";
input string InpCustomSymbol = "GOLD10B-H4-CANON";
input string InpCsvFile = "Gold24NativeH4\\gold24_canonical_h4_mt5.csv";
input string InpReceiptFile = "Gold24NativeH4\\import_receipt.txt";
input int InpExpectedRows = 0;

void Fail(string msg,int code=2)
{
   Print("GOLD10B_H4_IMPORT_FAIL ",msg," err=",GetLastError());
