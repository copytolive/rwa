...
// trades=126, WR=65.079365079365%, PF=1.224957825929, NetProfit=USD 27572.409000000000
...
input ulong  InpMagic        = 24090103;

const datetime CANONICAL_START = D'2000.10.23 00:00';
const int FAST=3;
const int SLOW=100;
const double SL_USD=22.0;
const double TP_USD=23.0;
const double OFFSET_USD=1.0;
const int EXPIRY_BARS=7;
