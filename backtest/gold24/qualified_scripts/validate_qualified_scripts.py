...
MULTI=['multi_rank01_donchian_f3_s89_off4_75_exp3','multi_rank02_candle_engulfing_f20_s144_off2_exp5','multi_rank03_candle_engulfing_f26_s144_off2_exp8','multi_rank04_candle_engulfing_f89_s144_off4_5_exp5','multi_rank05_candle_engulfing_f34_s144_off1_exp8','multi_rank06_candle_engulfing_f26_s144_off1_5_exp6']
ALL=STRICT+MULTI
...
def main():
    ...
    payload={'status':'PASS','strict_count':len(STRICT),'multi_count':len(MULTI),'total_method_pairs':len(ALL),'checks':results,'contract':{'python':'exact canonical core.py qty=100 parity','mt5':'native compile/runtime certification; signal/order translation checked against each Python candidate','broker_pnl_note':'broker-specific spread/commission/swap/tick sequence can differ from canonical stressed cost model'}}
