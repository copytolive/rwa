...
if(typeof window!=='undefined'){window.RWATradeLaunchGate={version:'1.0.0',refresh:refreshGate,canMainnet,reason:gateReason,state:()=>({...GATE,wallet:wallet(),walletE2E:walletE2E()})};setTimeout(refreshGate,0);setInterval(refreshGate,60000);window.addEventListener('focus',()=>refreshGate())}

const BASE={
  version:'1.4.0',
  build:'github-pages-rwa-trade-pro-machine-gated-2026-08-24',
