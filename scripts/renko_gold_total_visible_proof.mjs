...
await page.waitForFunction(()=>document.querySelector('#chartHost canvas')&&document.documentElement.dataset.renkoGoldRecent==='true'&&window.RWARenkoGoldTotalHistory&&window.RWARenkoGoldTotalVisible?.version==='1.0.1-total-visible-autoload-proof-isolated',{timeout:120000});
