...
export class MidtransPayment {
  ...
  async refund(order,{amountCents=null,reason='Customer refund',refundKey=''}={}){
    ...
    // Partial refunds require item-level return/restock accounting. Until that
    // ledger exists, the provider path is full-refund only so local order state
    // can never claim the entire order was refunded after a partial settlement.
