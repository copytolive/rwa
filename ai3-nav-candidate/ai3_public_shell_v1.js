...
function normalizeTopNav(){
  ...
  Array.from(document.querySelectorAll("nav")).forEach(nav=>{
    ...
    const t=norm(nav.innerText),names=["Home","Fundamental","Signal Scan","Crypto","Renko"];
    if(!names.every(x=>t.includes(x)))return;
    const bs=Array.from(nav.querySelectorAll(":scope > button")).filter(b=>norm(b.innerText)!=="Hyperliquid");
    if(bs.length!==5)return;
    nav.dataset.ai3Navlock="1";
    nav.style.setProperty("box-sizing","border-box","important");
    nav.style.setProperty("gap",g+"px","important");
    nav.style.setProperty("width",total+"px","important");
    nav.style.setProperty("min-width",total+"px","important");
    nav.style.setProperty("max-width",total+"px","important");
    nav.style.setProperty("justify-content","center","important");
    nav.style.setProperty("align-items","center","important");
    bs.forEach(b=>{
      b.style.setProperty("box-sizing","border-box","important");
      b.style.setProperty("flex","0 0 "+w+"px","important");
      b.style.setProperty("width",w+"px","important");
      b.style.setProperty("min-width",w+"px","important");
      ...
      b.style.setProperty("max-height",h+"px","important");
      b.style.setProperty("padding","6px 2px 4px","important");
      b.style.setProperty("gap","3px","important");
...
document.addEventListener("click",ai3SignalBack,true);
