...
ok(18,'SPEED_RELIABILITY',html.includes('Historical bars first')===false&&html.includes('data-api.binance.vision/api/v3/klines')&&js.includes('rwa:p20-ready')&&js.includes('softRetry')&&/const CACHE='rwa-superapp-v5-shell-\d+'/.test(sw)&&scripts<=14);
...
need(scripts<=14,`legacy root external scripts=${scripts}, expected <=14`);
console.log(pass.join('\n'));console.log(`ROOT_SCRIPT_COUNT=${scripts}`);console.log('CANONICAL_NEXT_PAGES=PASS');console.log('P16_P20_STATIC_AUDIT=PASS');
