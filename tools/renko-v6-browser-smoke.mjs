...
try{
  ...
  await page.click('#historyPrev');await page.waitForFunction(b=>window.RWARenkoV6.state.bars.length>b.bars,before,{timeout:10000});
  ...
  console.log(JSON.stringify({ok:true,contract:'renko-v6-tradingview-compatible-lazy-50-all-spot-search',initial,search,before,olderState,live,back,cache},null,2));
  await context.close();
