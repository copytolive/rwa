...
await browser.close();const out={ok:failures.length===0,contract:'ecommerce-root-first-paint-0ms-v1.6',base,publicMode,results,failures};await writeFile(`${proof}/browser-result.json`,JSON.stringify(out,null,2));console.log(JSON.stringify(out,null,2));if(!out.ok)process.exit(1);
