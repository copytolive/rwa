...
try{
  ...
  fs.writeFileSync('beta-proof-success.txt',JSON.stringify({wallet,phase,fill_count:fills.length,verified_at:now}));
  console.log(`BETA VERIFIED ${phase} ${wallet} fills=${fills.length}`);
