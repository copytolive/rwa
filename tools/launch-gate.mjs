...
const out={schema:4,generated_at:new Date().toISOString(),status,engineering_ready,beta_ready,beta_passed,mainnet_ready,evidence_policy:RWA_EVIDENCE_POLICY,beta:{thresholds,counts:betaCounts,verified_proofs:proofs.length},checks,blockers,revenue:'DEFERRED',token_tge:'DEFERRED'};
