...
(()=>{if(window.RWASeablueprintCommerceBridge)return;import('./rwa-seablueprint-commerce-bridge.js?v=1.2.1').catch(()=>console.error('Seablueprint single-shell commerce bridge failed to load'))})();
