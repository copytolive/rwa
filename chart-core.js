...
(async()=>{try{
  ...
  if(!document.querySelector('link[data-rwa-target-livehome]')){const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-live-home-v1.css?v=4.1.0.1';l.dataset.rwaTargetLivehome='1';document.head.appendChild(l)}
