...
(async()=>{try{
  ...
  if(!document.querySelector('link[data-rwa-target-livehome]')){const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-live-home-v1.css?v=4.2.1';l.dataset.rwaTargetLivehome='1';document.head.appendChild(l)}
  if(!window.RWALiveHome)await import('./rwa-live-home-v1.js?v=4.2.1');
