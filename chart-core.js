...
/* RWA_UI_LAYOUT_INTEGRITY_V15_BOOTSTRAP */
(()=>{if(document.querySelector('script[data-rwa-ui-layout-v15]'))return;const s=document.createElement('script');s.src='ui-layout-integrity-v15.js?v=15';s.async=false;s.dataset.rwaUiLayoutV15='1';s.onerror=()=>console.error('RWA UI Layout Integrity V15 failed to load');document.head.appendChild(s)})();
