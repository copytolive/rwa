...
(async()=>{try{
  ...
  if(!window.RWALiveHome)await import('./rwa-live-home-v1.js?v=5.0.0');
  if(!document.querySelector('link[data-rwa-terminal-v5]')){const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-terminal-v5.css?v=1.0.0';l.dataset.rwaTerminalV5='1';document.head.appendChild(l)}
  if(!window.RWATerminalV5)await import('./rwa-terminal-v5.js?v=1.0.0');
