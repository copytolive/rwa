...
(async()=>{try{
  for(const[key,href]of[['v2','rwa-target-dashboard-v2.css?v=2.0.0'],['hardening','rwa-target-dashboard-v2-hardening.css?v=2.1.0'],['orderbook','rwa-ecommerce-orderbook-parity-v1.css?v=1.0.0']]){
  ...
  if(!window.RWALiveHome)await import('./rwa-live-home-v1.js?v=1.0.0');
