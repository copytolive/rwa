...
(()=>{for(const [key,href] of [['base','rwa-target-dashboard-v1.css?v=1.1.0'],['compat','rwa-target-dashboard-v1-compat.css?v=1.1.0'],['workspace','rwa-target-dashboard-v1-workspace.css?v=1.1.0']]){if(document.querySelector(`link[data-rwa-target-dashboard-${key}]`))continue;const l=document.createElement('link');l.rel='stylesheet';l.href=href;l.dataset[`rwaTargetDashboard${key[0].toUpperCase()+key.slice(1)}`]='1';document.head.appendChild(l)}if(window.RWATargetDashboardV1)return;import('./rwa-target-dashboard-v1.js?v=1.1.0').catch(()=>console.error('RWA target dashboard V1 failed to load'))})();
