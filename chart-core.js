...
(async()=>{try{
  for(const[key,href]of[['v2','rwa-target-dashboard-v2.css?v=2.0.0'],['hardening','rwa-target-dashboard-v2-hardening.css?v=2.1.0'],['orderbook','rwa-ecommerce-orderbook-parity-v1.css?v=2.0.0'],['livehome','rwa-live-home-v1.css?v=1.1.0']]){
