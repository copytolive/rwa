...
(()=>{if(document.querySelector('script[data-rwa-seablueprint-commerce]'))return;const s=document.createElement('script');s.src='rwa-seablueprint-commerce-bridge.js?v=1';s.async=false;s.dataset.rwaSeablueprintCommerce='1';s.onerror=()=>console.error('Seablueprint single-shell commerce bridge failed to load');document.head.appendChild(s)})();
