...
(async()=>{try{
  ...
  if(!document.querySelector('link[data-rwa-reference-v22-final]')){const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-terminal-reference-v22-final.css?v=2.2.2';l.dataset.rwaReferenceV22Final='1';document.head.appendChild(l);await new Promise((res,rej)=>{l.onload=res;l.onerror=rej})}
  if(!window.RWAReferenceParityV22Final)await import('./rwa-terminal-reference-v22-final.js?v=2.2.2');
