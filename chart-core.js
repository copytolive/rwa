...
(async()=>{try{if(!document.querySelector('link[data-rwa-target-dashboard-v2]')){const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-target-dashboard-v2.css?v=2.0.0';l.dataset.rwaTargetDashboardV2='1';document.head.appendChild(l)}if(!window.RWATargetDashboardV2)await import('./rwa-target-dashboard-v2.js?v=2.0.0');if(!window.RWASeablueprintCommerceBridge)await import('./rwa-seablueprint-commerce-bridge.js?v=1.4.0')}catch(e){console.error('RWA target/commerce inline grid failed to load',e)}})();
