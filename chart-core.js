...
(async()=>{try{
  ...
  {const l=document.createElement('link');l.rel='stylesheet';l.href='rwa-terminal-v5.css?v=1.0.5';l.dataset.rwaTerminalV5='1';document.head.appendChild(l)}
  if(!window.RWATerminalV5)await import('./rwa-terminal-v5.js?v=1.0.13');
